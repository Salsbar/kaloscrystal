...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const FLASH        ; 94
	const PSYWAVE      ; 95
	const DRAININGKISS ; 96
	const ACID_ARMOR   ; 97
	const WOOD_HAMMER  ; 98
	const EXPLOSION    ; 99
	const FURY_SWIPES  ; 9a
	const FLARE_BLITZ  ; 9b
	const REST         ; 9c
	const ROCK_SLIDE   ; 9d
	const HYPER_FANG   ; 9e
	const SHARPEN      ; 9f
	...
	const STRUGGLE     ; a5
	const MOONBLAST    ; a6
	const FLYING_PRESS ; a7
	const THIEF        ; a8
	const SHADOW_SNEAK ; a9
