...
; ???
	...
	const EVENT_FUCHSIA_CITY_SHELL_STONE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_SUN_STONE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_THUNDERSTONE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_SHELL_STONE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_FIRE_STONE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_LEAF_STONE
	const EVENT_GOT_SNIVY_FROM_OFFICER
	const EVENT_GOT_OSHAWOTT_FROM_FUJI
	const EVENT_GOT_TEPIG_FROM_YOUNGSTER
	const EVENT_10F
	const EVENT_110
	const EVENT_111
	const EVENT_112
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_BEAT_RIVAL_IN_INDIGO_PLATEAU
	const EVENT_GOT_GS_BALL_FROM_POKECOM_CENTER
; ???
	const EVENT_GOT_STARTER_FROM_RIVAL
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_TERRAKION
	const EVENT_FOUGHT_TERRAKION
	const EVENT_ROUTE_35_VIRIZION
	const EVENT_FOUGHT_VIRIZION
	const EVENT_CIANWOOD_CITY_COBALION
	const EVENT_FOUGHT_COBALION
	const EVENT_FOUGHT_KELDEO
	const EVENT_SILVER_CAVE_DRAGONS_1
	const EVENT_SILVER_CAVE_DRAGONS_2
	const EVENT_DRAGONS_LEFT
	const EVENT_ROUTE_10_NORTH_ZEKROM
	const EVENT_FOUGHT_ZEKROM
	const EVENT_CERULEAN_CITY_RESHIRAM
	const EVENT_FOUGHT_RESHIRAM
	const EVENT_ROUTE_20_KYUREM
	const EVENT_FOUGHT_KYUREM
	const EVENT_GOT_PRISON_BOTTLE
	const EVENT_CINNABAR_ISLAND_VOLCANION
	const EVENT_FOUGHT_VOLCANION
	const EVENT_GOT_VOLCANIC_ASH
	const EVENT_356
	const EVENT_357
	const EVENT_358
	const EVENT_359
