...
CeruleanCityCooltrainerFText1:
	text "My STUNFISK and I"
	line "make an awesome"
	cont "combination!"
	done

CeruleanCityCooltrainerFText2:
	text "STUNFISK, show me"
	line "your THUNDERSHOCK!"
	done
...
CeruleanCity_MapEvents:
	...
	object_event 20, 24, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CeruleanCitySlowbro, -1
