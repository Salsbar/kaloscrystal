...
.GotStarter2
	...
	writetext ElmGiveMasterBallText3
	waitbutton
.notdone
	closetext
	end
...
ElmGiveMasterBallText2:
	text "I'd also like you"
	line "to have this!"
	done

ElmGiveMasterBallText3:
