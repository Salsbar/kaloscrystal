...
; entries correspond to constants/move_constants.asm
	...
	move STORM_THROW,  EFFECT_NORMAL_HIT,         90, FIGHTING, 100, 10,   0
	...
	move HEAD_CHARGE,  EFFECT_RECOIL_HIT,        130, NORMAL,   100, 15,   0
	...
	move QUIVER_DANCE, EFFECT_QUIVER_DANCE,        0, BUG,      100, 10,   0
	...
	move SACRED_SWORD, EFFECT_NORMAL_HIT,        120, FIGHTING, 100, 15,   0
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC,  100, 20,   0
	move NOBLE_ROAR,   EFFECT_NOBLE_ROAR,          0, NORMAL,   100, 30,   0
	move HURRICANE,    EFFECT_CONFUSE_HIT,       110, FLYING,    70, 10,  30
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         100, FIGHTING,  90, 10,   0
	...
	move DRAININGKISS, EFFECT_LEECH_HIT,          50, FAIRY,    100, 10,   0
	...
	move FLYING_PRESS, EFFECT_FLYING_PRESS,       80, FLY_P,     95, 10,   0
	...
	move GEAR_GRIND,   EFFECT_DOUBLE_HIT,         50, STEEL,     85, 15,   0
	...
	move SHIFT_GEAR,   EFFECT_SHIFT_GEAR,          1, STEEL,    100, 10,   0
	...
	move NIGHT_DAZE,   EFFECT_ACCURACY_DOWN_HIT,  85, DARK,      95, 10,  40
	...
	move METEOR_MASH,  EFFECT_ATTACK_UP_HIT,     100, STEEL,     90, 10,  20
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      100, PSYCHIC,  100, 10,   0
