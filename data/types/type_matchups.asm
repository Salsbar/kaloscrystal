TypeMatchups: ; 34bb1
	...
	db FLY_P,     GRASS,     SUPER_EFFECTIVE
	db FLY_P,     ELECTRIC,  NOT_VERY_EFFECTIVE
	db FLY_P,     ICE,       SUPER_EFFECTIVE
	db FLY_P,     POISON,    NOT_VERY_EFFECTIVE
	db FLY_P,     FIGHTING,  SUPER_EFFECTIVE
	db FLY_P,     FLYING,    NOT_VERY_EFFECTIVE
	db FLY_P,     PSYCHIC,   NOT_VERY_EFFECTIVE
	db FLY_P,     DARK,      SUPER_EFFECTIVE
	db FLY_P,     FAIRY,     NOT_VERY_EFFECTIVE
	db FLY_P,     NORMAL,    SUPER_EFFECTIVE
